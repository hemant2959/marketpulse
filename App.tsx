...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden text-slate-800 dark:text-slate-200 pb-24 selection:bg-cyan-500/30 bg-transparent">
      ...
      <main className="max-w-7xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="sticky top-[64px] z-30 pt-2 pb-4 -mx-4 px-4 bg-gradient-to-b from-[var(--bg-color)] via-[var(--bg-color)] to-transparent transition-colors duration-300">
          ...
          {viewMode === 'list' ? (
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-3 pb-8">
                {filteredStocks.map(stock => {
                    ...
                    if (p >= 3.0) {
                      // Extreme Bull (>3.0%)
                      bgClass = 'bg-emerald-600 dark:bg-emerald-500 shadow-[0_0_20px_rgba(16,185,129,0.6)] z-20 scale-[1.05] ring-2 ring-emerald-400 dark:ring-emerald-300';
                      textClass = 'text-white font-black text-shadow'; // boldest
                      borderClass = 'border-transparent';
                    } else if (p >= 1.5) {
                      // Strong Bull (>1.5%)
                      bgClass = 'bg-emerald-500 dark:bg-emerald-600 shadow-[0_0_10px_rgba(16,185,129,0.4)] z-10 scale-[1.02]';
                      textClass = 'text-white font-bold';
                      borderClass = 'border-emerald-400/50';
                    } else if (p >= 0.8) {
                      // Moderate Bull (>0.8%)
                      bgClass = 'bg-emerald-400 dark:bg-emerald-700/80';
                      textClass = 'text-white dark:text-emerald-100 font-bold';
                      borderClass = 'border-emerald-300/30 dark:border-emerald-500/30';
                    } else if (p >= 0.25) {
                      // Mild Bull (>0.25%)
                      bgClass = 'bg-emerald-200 dark:bg-emerald-800/60';
                      textClass = 'text-emerald-900 dark:text-emerald-200 font-semibold';
                      borderClass = 'border-emerald-300/30 dark:border-emerald-600/30';
                    } else if (p > 0) {
                      // Subtle Bull (>0.0%) - Make it very faint
                      bgClass = 'bg-emerald-50 dark:bg-emerald-900/20';
                      textClass = 'text-emerald-800 dark:text-emerald-300/80 font-medium';
                      borderClass = 'border-emerald-100 dark:border-emerald-800/20';
                    } else if (p <= -3.0) {
                      // Extreme Bear (<-3.0%)
                      bgClass = 'bg-rose-600 dark:bg-rose-500 shadow-[0_0_20px_rgba(225,29,72,0.6)] z-20 scale-[1.05] ring-2 ring-rose-400 dark:ring-rose-300';
                      textClass = 'text-white font-black text-shadow';
                      borderClass = 'border-transparent';
                    } else if (p <= -1.5) {
                      // Strong Bear (<-1.5%)
                      bgClass = 'bg-rose-500 dark:bg-rose-600 shadow-[0_0_10px_rgba(225,29,72,0.4)] z-10 scale-[1.02]';
                      textClass = 'text-white font-bold';
                      borderClass = 'border-rose-400/50';
                    } else if (p <= -0.8) {
                      // Moderate Bear (<-0.8%)
                      bgClass = 'bg-rose-400 dark:bg-rose-700/80';
                      textClass = 'text-white dark:text-rose-100 font-bold';
                      borderClass = 'border-rose-300/30 dark:border-rose-500/30';
                    } else if (p <= -0.25) {
                      // Mild Bear (<-0.25%)
                      bgClass = 'bg-rose-200 dark:bg-rose-800/60';
                      textClass = 'text-rose-900 dark:text-rose-200 font-semibold';
                      borderClass = 'border-rose-300/30 dark:border-rose-600/30';
                    } else if (p < 0) {
                      // Subtle Bear (<0.0%)
                      bgClass = 'bg-rose-50 dark:bg-rose-900/20';
                      textClass = 'text-rose-800 dark:text-rose-300/80 font-medium';
                      borderClass = 'border-rose-100 dark:border-rose-800/20';
                    } else {
                      ...
                      borderClass = 'border-slate-200 dark:border-slate-700/30';
                    }
